...
import com.example.movieinfo.data.moviesDto.StaffFullInfoImpl
...
val dragonEpisodeList = listOf(dragonEpisode, dragonEpisode, dragonEpisode, dragonEpisode,
...
object : StateFlow<List<MovieCollection>> {
    ...
    override val value: List<MovieCollection> = listOf(emptyMovieCard,
        emptyMovieCard,
        emptyMovieCard,
        emptyMovieCard,
        emptyMovieCard,
...
val actorsForPreview = listOf(actorCardForPreview,
    actorCardForPreview,
    actorCardForPreview,
    actorCardForPreview,
    actorCardForPreview,
...
val filmographyForPreview = listOf(staffMovie, staffMovie, staffMovie, staffMovie, staffMovie,
    staffMovie, staffMovie, staffMovie, staffMovie, staffMovie, staffMovie, staffMovie)
val galleryForPreview = listOf(galleryItem, galleryItem, galleryItem, galleryItem, galleryItem,
